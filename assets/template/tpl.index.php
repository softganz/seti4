...
<script src="<?php echo Url::js('js/library'.(cfg('library.version') ? '-'.cfg('library.version') : '').(empty($_COOKIE['devMode']) ? '.min.js' : '.js'), cfg('theme.stylesheet.para'));?>"></script>
<script src="<?php echo Url::js((empty($_COOKIE['devMode']) ? 'js/sgui.min.js' : 'js/sgui.js'), cfg('theme.stylesheet.para'));?>"></script>
