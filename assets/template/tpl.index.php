...
<script src="<?php echo Url::js('js/library'.(cfg('library.version') ? '-'.cfg('library.version') : '').(_DEV_MODE ? '.js' : '.min.js'), cfg('theme.stylesheet.para'));?>"></script>
<script src="<?php echo Url::js((_DEV_MODE ? 'js/sgui.js' : 'js/sgui.min.js'), cfg('theme.stylesheet.para'));?>"></script>
