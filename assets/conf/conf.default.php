...
$cfg['photo.file_type'] = ['image/gif','image/jpeg','image/png','image/pjpeg','image/webp'];
...
$cfg['files.extension.allow'] = ['pdf','odt','ppt','rar','zip','tar','gz','iso','jpg','png','gif','mmap','mm'];
$cfg['files.extension.notallow'] = ['php','html','htm','jsp','py'];
...
$cfg['page.extension'] = ['htm','html','php'];
