...
if (mydb::table_exists('calendar')) {
	if (!mydb::columns('calendar','options')) {
		...
		$result[$version][] = array('Change table calendar add field options.', R('query'), mydb()->_error, mydb()->_error_no );
		...
		$result[$version][] = array('Upgrade table calendar option from property.', R('query'), mydb()->_error, mydb()->_error_no );
	...
	if (!mydb::columns('calendar','orgid')) {
		...
		$result[$version][] = array('Upgrade table calendar add field orgid.', R('query'), mydb()->_error, mydb()->_error_no );
	}
...
if (!mydb::columns('topic','areacode')) {
	...
	$result[$version][]=array('Add field areacode to topic.', R('query'), mydb()->_error, mydb()->_error_no);
}
...
if (!mydb::columns('users', 'areacode')) {
	...
	$result[$version][]=array('Add field areacode to users.', R('query'), mydb()->_error, mydb()->_error_no);
}
...
if (!mydb::columns('topic','approve')) {
	...
	$result[$version][]=array('Add field approve to topic.', R('query'), mydb()->_error, mydb()->_error_no);
}
...
if (mydb::table_exists('db_person')) {
	if (!mydb::columns('db_person','userId')) {
		...
		$result[$version][]=array('Change table db_person add field userId.', R('query'), mydb()->_error, mydb()->_error_no );
	}
	...
	if (!mydb::columns('db_person','areacode')) {
		...
		$result[$version][]=array('Change table db_person add field areacode,hrareacode.', R('query'), mydb()->_error, mydb()->_error_no );
	}
	...
	if (!mydb::columns('db_person','module')) {
		...
		$result[$version][]=array('Change table db_person add field module.', R('query'), mydb()->_error, mydb()->_error_no );
	}
