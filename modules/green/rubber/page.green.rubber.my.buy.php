...
function green_rubber_my_buy($self, $landId = NULL) {
	...
	new Toolbar($self, 'รับซื้อน้ำยาง @'.$headerTitle,'my.rubber.buy',$landInfo);
	...
	$ret .= '<section id="green-my-animal" data-url="'.url('green/my/rubber/buy/'.$landId).'">';
