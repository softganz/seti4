<?php
/**
* Green : Rubber Plant Information
* Created 2020-11-14
* Modify  2020-11-14
*
* @param Object $self
...
function green_rubber_my_rubber_view($self, $plantId) {
	...
	if ($isItemEdit) {
		$headerUi->add('<a class="sg-action" href="'.url('green/rubber/my/rubber/form/'.$plantId).'" data-rel="box" data-width="640"><i class="icon -material">edit</i></a>');
		...
		if ($plantInfo->msgId) {
			$dropUi->add('<a class="sg-action" href="'.url('green/my/plant/'.$plantInfo->plantId.'/crop').'" data-rel="box"><i class="icon -material">content_cut</i><span>โค่นต้นยาง</span></a>');
			$dropUi->add('<sep>');
	...
	$ret = '<section id="green-my-plant-view" data-url="'.url('green/rubber/my/rubber/view/'.$plantId).'">';
	...
	$ret .= '</section><!-- green-my-plant-view -->';
