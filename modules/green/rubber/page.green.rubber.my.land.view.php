...
* @return String
*
* @usage green/rubber/my/land/{$Id}
*/

$debug = true;

function green_rubber_my_land_view($self, $landId = NULL) {
	$landInfo = R::Model('green.land.get', $landId, '{data: "orgInfo,plantInfo"}');
	...
	if (cfg('green')->land->showPlantMenu) {
		...
		if ($isAddPlant) {
			$mainUi->add('<a class="sg-action" href="'.url('green/rubber/my/rubber/form',array('land' => $landId)).'" data-rel="box" data-width="480" data-webview="แปลงสวนยาง"><i class="icon -material">add</i><span>ปลูกยาง</span></a>');
			$mainUi->add('<a class="sg-action" href="'.url('green/rubber/my/tree/form',array('land' => $landId)).'" data-rel="box" data-width="480" data-webview="ธนาคารต้นไม้"><i class="icon -material">add</i><span>ปลูกธนาคารต้นไม้</span></a>');
			$mainUi->add('<a class="sg-action" href="'.url('green/my/plant/form',array('land' => $landId)).'" data-rel="box" data-width="480" data-webview="พืชผสมผสาน"><i class="icon -material">add</i><span>ปลูกพืชผสมผสาน</span></a>');
		}
