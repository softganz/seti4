...
function green_my_land_map($self, $landId = NULL) {
	...
	if ($isEdit) {
		...
		$form = new Form('data', url('green/my/info/land.save/'.$landId), 'form-map', 'sg-form -map');
	...
	function initProjectMap() {
		...
		var locationUpdate = function(latLng) {
			...
			para.data = data
			$.post("'.url('green/my/info/land.save/'.$landId).'", para, function(data) {
