...
function green_news($self) {
	...
	if ($stickyTopic->_num_rows) {
		...
		$ret .= '<div class="sg-slider banner-top"><a href="{url:tags/'.$tagId.'}" style="margin: 0; display: block;"><img src="https://communeinfo.com/upload/banner-green-01.jpg" width="100%" /></a></div>';
