...
function view_green_goods_render_card($rs, $options = '{}') {
	...
	if ($style == 'short') {
		...
		$ret .= '<div class="photo-th'
			. ($photo->_url ? '' : ' -no-photo').'">';
		if ($photo->_url) {
			$ret .= $url.'<img class="photo'
			. ($photo->_size->width > $photo->_size->height ? ' -wide' : ' -tall')
			. '" src="'.$photo->_url.'" height="140" /></a>';
		}
		/*
		...
		*/
		...
		//$ret .= '<a class="btn -link -disabled" href="">หยิบใส่ตะกร้า</a>';
