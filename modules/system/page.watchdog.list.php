...
class WatchdogList extends Page {
	var $ip;
	var $user;
	var $date;
	var $keyword;
	...
	function __construct($args = NULL) {
		parent::__construct([
			'items' => SG\getFirst(Request::all('items', 'int'), $this->items),
			'ip' => Request::all('ip', 'numeric'),
			'user' => Request::all('user', 'int'),
			'date' => Request::all('date', 'numeric'),
