<?php
function view_test_toolbar($self,$title=NULL,$nav='default',$psn=NULL,$options='{}') {
	$defaults='{menu:""}';
...
/*
	...
	*/
	$subnav=R::View('test.'.$nav.'.nav',$psn,$options);
	if ($subnav) {
		$ret.='<nav class="nav -submodule -imed"><!-- nav of test.'.$nav.'.nav -->';
		$ret.=$subnav;
		$ret.='</nav><!-- submodule -->';
	}
