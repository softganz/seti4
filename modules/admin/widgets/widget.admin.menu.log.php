				...
				new Card([
					'children' => [
						new ListTile([
							...
							'trailing' => new Button([
								'class' => 'btn',
								'url' => url('watchdog/list/keyword/access denied'),
				...
				new Card([
					'children' => [
						new ListTile([
							...
							'trailing' => new Button([
								'class' => 'btn',
								'url' => url('watchdog/list/keyword/page not found'),
