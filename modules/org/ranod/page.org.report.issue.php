<?php
	 ...
	 *
	 */
	function org_report_issue($self,$action,$id) {
		$ret.='Action='.$action.' ID='.$id;
		$para=para(func_get_args(),1);
		$ret.=print_o($para,'$para');
		$self->theme->title='รายงานจำนวนคนเข้าร่วมกิจกรรมแยกตามประเด็น รพ.ระโนด';
