...
* @return String
*
* Example : http://i.giphy.com/cvz0hTnZx08py.gif
*/

function flood_forcast_gmap($self) {
	...
	$(document).ready(function() {
		...
		(function pollServerForNewMail() {
			...
			$.getJSON(url+"flood/forcast/get",{d: "'.$dateForcast.'", hr:forcastIdx},function(data) {
				console.log(data)
				if (data.title) {
				}
