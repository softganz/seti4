<?php
/**
* flood_monitor_datayear
*
* @param Object $self
* @return String
*/
function flood_monitor_datayear($self) {
	$ret.='<div class="flood__realtime">';
	$ret.='<h2>คลังข้อมูล</h2>';
	$ret.='<form><label>ชนิดข้อมูล</label><select class="form-select"><option>เลือกชนิดข้อมูล</option></select><label>เลือกแหล่งข้อมูล</label><select class="form-select"><option>เลือกแหล่งข้อมูล</option></select><label>ช่วงปีพุทธศักราช</label><select class="form-select"><option>2558</option><option>2557</option></select><button>ดู</button></form>';
