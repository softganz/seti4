...
function flood_chat_home($self) {
	...
	$ret .= '<div id="flood-chat-send" class="ui-card flood-chat-send">'
			...
			. '<a class="sg-action form-text" id="sendtext" href="'.url('flood/chat/form').'" placeholder="แจ้งสถานการณ์?" data-rel="replace:#flood-chat-send" data-webview="แจ้งสถานการณ์">แจ้งสถานการณ์?</a>&nbsp;'
			. '<a class="sg-action btn -link" href="'.url('flood/chat/form').'" data-rel="replace:#flood-chat-send" data-webview="แจ้งสถานการณ์"><i class="icon -camera"></i><span>Photo</span></a>'
			. '</div>'
			. '</div>';
