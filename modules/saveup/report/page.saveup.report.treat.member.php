...
* @return String
*
* @usage saveup/report/treat/member
*/

$debug = true;

function saveup_report_treat_member($self) {
	$para=para(func_get_args());
	$year=$_GET['year']?$_GET['year']:date('Y');

	R::View('saveup.toolbar',$self,'รายการค่ารักษาพยาบาลของสมาชิก ประจำปี '.($year+543),'treat');
