<?php
/**
* Project :: Fund Board Create New Letter
* Created 2019-05-07
* Modify  2020-06-11
*
* @param Object $self
...
* @return String
*
* @call project/fund/$orgId/board.letter.new/$tranId
*/

$debug = true;

function project_fund_board_letter_new($self, $fundInfo, $tranId) {
	...
	mydb::where('tr.`trid` = :trid AND tr.`refcode` = "new" AND tr.`formid` = "fund" AND tr.`part` = "boardletter" AND `refid` = :orgid', ':trid', $tranId, ':orgid',$orgId);
...
เรื่อง แต่งตั้งคณะกรรมการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่</h3>
<hr />
<p class="-indent">เพื่อให้การดำเนินงานและการบริหารจัดการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่มีความเหมาะสม ส่งเสริมกระบวนการการมีส่วนร่วมตามความพร้อมและความต้องการของประชาชนในท้องถิ่นหรือพื้นที่</p>
...
<p class="-indent">ข้อ ๑ แต่งตั้งคณะกรรมการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่ ตามบัญชีรายละเอียดแนบท้ายคำสั่งนี้</p>
<p class="-indent">ข้อ ๒ ให้คณะกรรมการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่ ตามข้อ ๑ มีวาระอยู่ในตำแหน่งและมีอำนาจหน้าที่ ตามประกาศคณะกรรมการหลักประกันสุขภาพแห่งชาติ เรื่อง การกำหนดหลักเกณฑ์เพื่อสนับสนุนให้องค์กรปกครองส่วนท้องถิ่น ดำเนินงานและบริหารจัดการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่ พ.ศ.๒๕๖๑ ลงวันที่ ๑ ตุลาคม พ.ศ. ๒๕๖๑</p>
<p class="-indent">ข้อ ๓ การแต่งตั้งคณะกรรมการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่ ตามข้อ ๑ ให้มีผลตั้งแต่บัดนี้เป็นต้นไป เว้นแต่กรณีที่มีการประชุมคณะกรรมการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่ ตามอำนาจหน้าที่ก่อนมีคำสั่งนี้ ให้ถือว่าการแต่งตั้งคณะกรรมการกองทุนหลักประกันสุขภาพในระดับท้องถิ่นหรือพื้นที่ มีผลตั้งแต่วันที่มีการประชุม</p>
<div class="signbox">
