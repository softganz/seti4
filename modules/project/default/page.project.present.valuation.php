...
* @return String
*/
function project_present_valuation($self) {
	$goodGroup=post('g');
	$getSector = post('s');
	$getPlan = post('p');
	$getYear = post('yy');
	...
	$ui->add('<a class="btn -primary" href="'.url('project/present/valuation').'"><i class="icon -material">how_to_reg</i><span>ประเมินคุณค่า</span></a>');
	...
	$valueList = array(
		...
		'https://dekthaikamsai.com/,inno.1' => '1. การเกษตรในโรงเรียน',
		'https://dekthaikamsai.com/,inno.2' => '2. สหกรณ์นักเรียน',
		'https://dekthaikamsai.com/,inno.3' => '3. การบริหารจัดการอาหารของโรงเรียน',
		'https://dekthaikamsai.com/,inno.4' => '4. การเฝ้าระวังและติดตามภาวะโภชนาการ และสมรรถภาพทางกายนักเรียน',
		'https://dekthaikamsai.com/,inno.5' => '5. การพัฒนาสุขนิสัยและการส่งเสริมสุขภาพอนามัยนักเรียน',
		'https://dekthaikamsai.com/,inno.6' => '6. การพัฒนาอนามัยสิ่งแวดล้อมของโรงเรียนให้ถูกสุขลักษณะ',
		'https://dekthaikamsai.com/,inno.7' => '7. การจัดบริการสุขภาพนักเรียน',
		'https://dekthaikamsai.com/,inno.8' => '8. การจัดการเรียนรู้เกษตร สหกรณ์ อาหาร โภชนาการและสุขภาพอนามัย',
		'https://dekthaikamsai.com/,inno.9' => '9. อื่น ๆ',
		'https://happynetwork.org/' => 'ชุมชนน่าอยู่',
		'https://happynetwork.org/,inno' => '1. เกิดความรู้ หรือ นวัตกรรมชุมชน',
		'https://happynetwork.org/,behavior' => '2. เกิดการปรับเปลี่ยนพฤติกรรมที่เอื้อต่อสุขภาพ',
		'https://happynetwork.org/,environment' => '3. การสร้างสภาพแวดล้อมที่เอื้อต่อสุขภาพ',
		'https://happynetwork.org/,publicpolicy' => '4. การพัฒนานโยบายสาธารณะที่เอื้อต่อสุขภาวะ',
		'https://happynetwork.org/,social' => '5. เกิดกระบวนการชุมชน',
		'https://happynetwork.org/,spirite' => '6. มิติสุขภาวะปัญญา/สุขภาวะทางจิตวิญญาณ',
	);
	...
	*/
	...
	var queryUrl = "project/api/marker/good"
	var projectSet
	var goodType
