...
* @return String
*/
function project_info_join_invite($self, $projectInfo, $calId = NULL) {
	...
	if ($doRs->doid) {
		...
		$ret.='<div class="sg-load" id="org-meeting-info" data-url="'.url('org/'.$doRs->orgid.'/meeting.info/'.$doRs->doid.'/invite').'"></div>';
	}
