...
* @return String
*/
function project_form_valuation($self,$projectinfo) {
	...
	$ret.='<h2>แบบฟอร์มการสังเคราะห์คุณค่าของโครงการ</h2>';
	...
	$ui->add('<a href="'.url('paper/'.$tpid.'/owner/valuation_v1').'" target="_blank">(แบบประเมินเวอร์ชั่นเก่า)</a>');
