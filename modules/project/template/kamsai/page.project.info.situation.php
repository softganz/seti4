<?php
/**
* Project Situation Menu
*
* @param Object $self
* @param Object $projectInfo
* @return String
*/
function project_info_situation($self, $projectInfo) {
	...
	$tables->rows[] = array('<a href="'.url('project/'.$tpid.'/info.learn').'">ผลสัมฤทธิ์ทางการเรียน</a>',number_format($counts['learn']));
	//$ret.=$tables->build();
