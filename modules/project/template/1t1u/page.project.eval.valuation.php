					...
					new Container([
						'children' => [
							...
							'<p>'
								...
								. '</p>'._NL,
							'<p><em>แบบประเมินคุณค่าของโครงการที่เกี่ยวข้องในมิติดังต่อไปนี้</p><ol><li>เกิดความรู้ หรือ นวัตกรรมชุมชน</li><li>การปรับเปลี่ยนพฤติกรรม</li><li>การปรับเปลี่ยนสิ่งแวดล้อม</li><li>ผลกระทบเชิงบวกและนโยบายสาธารณะ</li><li>กระบวนการชุมชน</li><li>มิติทางปัญญา/ทางจิตวิญญาณ</li></ol></em></p>',
						], // children
					]), // Container
