		...
		return new Widget([
			'children' => [
				...
				new Column([
					'class' => 'detail',
					'children' => [
						'<h5><a href="'.url('project/app/follow/'.$actionInfo->projectId).'">'.$actionInfo->title.'</a> @<a href="'.url('project/app/follow/'.$actionInfo->projectId).'">'.$actionInfo->projectTitle.'</a>'.($actionInfo->parentTitle ? '/<a href="'.url('project/app/follow/'.$actionInfo->parentId).'">'.$actionInfo->parentTitle.'</a>' : '').'</h5>',
