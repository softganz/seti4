...
function project_info_select_plateform($self, $projectInfo) {
	...
	$ret .= '<header class="header -box"><nav class="nav -back"><a class="sg-action" data-rel="back" href="javascript:void(0)"><i class="icon -material">arrow_back</i></a></nav><h3>เลือกแพลตฟอร์ม</h3></header>';

	$ret .= '<script type="text/javascript">
	$(document).ready(function() {
		var $formField = $("#edit-plateform")
	...
	$stmt = 'SELECT
		...
		WHERE tg.`taggroup` = "project:uokr:plateform" AND tg.`process` = 1;
		-- {group: "parentId"}
		';
