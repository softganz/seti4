...
function project_info_select_objective($self, $projectInfo) {
	...
	$ret .= '<header class="header -box"><nav class="nav -back"><a class="sg-action" data-rel="back" href="javascript:void(0)"><i class="icon -material">arrow_back</i></a></nav><h3>เลือกเป้าหมาย</h3></header>';

	$ret .= '<script type="text/javascript">
	$(document).ready(function() {
		var $formField = $("#edit-objective")
	...
	$stmt = 'SELECT
		...
		FROM %tag% tg
			LEFT JOIN %tag% tp ON tp.`taggroup` = "project:uokr:plateform" AND tp.`catid` = tg.`catparent`
