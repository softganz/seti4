...
class ProjectEvalInput extends Page {
	...
	function build() {
		...
		$outputList['1'] = array(
			'title'=>'1. ข้อมูลชุมชนใดบ้างที่มีและที่ใช้ข้อมูลในการดำเนินโครงการ',
			'field'=>'rate1,text1,text2',
			'items'=>array(
				array('section'=>'1','title'=>'ข้อมูลสถานการณ์สุขภาวะกาย'),
				array('section'=>'2','title'=>'ข้อมูลสถานการณ์สุขภาวะจิต'),
				array('section'=>'3','title'=>'ข้อมูลสถานการณ์สุขภาวะสังคม'),
		...
		$outputList['3']=array(
			'title'=>'3. ทุนของชุมชนที่มีส่วนสำคัญต่อการดำเนินงานของโครงการ',
			'field'=>'rate1,text1,text2',
			'items'=>array(
		...
		$outputList['5']=array(
			'title'=>'5. งบประมาณและทรัพยากร',
			'field'=>'rate1,text1,text2',
			'items'=>array(
				array('section'=>'1','title'=>'งบประมาณ'),
				array('section'=>'2','title'=>'ทรัพยากรอื่นๆ'),
			)
		);
		...
		$tables->colgroup = array('width="20%"','width="5%"','width="5%"','width="5%"','width="5%"','width="25%"','width="25%"','width="25%"');
		$tables->thead = '<thead>'
				. '<tr><th rowspan="2"></th><th colspan="2">มี</th><th colspan="2">ใช้</th><th rowspan="2">สาระสำคัญ</th><th rowspan="2">ที่มา</th></tr>'
				. '<tr><th style="width:30px;">มี</th><th style="width:30px;">ไม่มี</th><th style="width:30px;">ใช้</th><th style="width:30px;">ไม่ใช้</th></tr>'
				. '</thead>';

		foreach ($outputList as $mainKey=>$mainValue) {
			$tables->rows[] = array('<td colspan="7"><h3>'.$mainValue['title'].'</h3></td>');
	...
	function _script() {
		return '<style>
		.project-valuation-form td:nth-child(2), .project-valuation-form td:nth-child(3),.project-valuation-form td:nth-child(4), .project-valuation-form td:nth-child(5) {text-align:center;}
