...
function project_proposal_info_view($self, $proposalInfo, $action = NULL) {
	...
	if ($issueDbs->_num_rows) {
		...
		foreach ($issueDbs->items as $rs) {
			if ($isInEditMode) {
				...
				if ($rs->flddata) $optionsIssue[] = $rs->name;
			}
		}
	...
	$ret .= '<div class="header"><h3>4. วัตถุประสงค์</h3><a class="project-toogle-display -no-print" href="javascript:void(0)"><icon class="icon -up"></i></a></div>';
	...
	$ret .= '<div class="header"><h3>5. กลุ่มเป้าหมาย</h3><a class="project-toogle-display -no-print" href="javascript:void(0)"><icon class="icon -up"></i></a></div>';
	...
	$ret .= '<div class="header"><h3>6. ระยะเวลา</h3><a class="project-toogle-display -no-print" href="javascript:void(0)"><icon class="icon -up"></i></a></div>';
	...
	$ret .= '<div class="header"><h3>7. วิธีดำเนินงาน</h3><a class="project-toogle-display -no-print" href="javascript:void(0)"><icon class="icon -up"></i></a></div>';
	...
	$ret .= '<div class="header"><h3>8. งบประมาณ</h3><a class="project-toogle-display -no-print" href="javascript:void(0)"><icon class="icon -up"></i></a></div>';
