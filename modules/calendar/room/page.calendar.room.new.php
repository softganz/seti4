<?php
/**
* Calendar :: Create New Room Reservation
* Created  :: 2019-08-03
* Modify   :: 2022-12-05
* Version  :: 2
*
* @return Widget
*
* @usage calendar/room/new
*/

class CalendarRoomNew extends Page {
			...
			'body' => new Widget([
				'children' => [
					new Form([
						'class' => 'sg-form',
						'variable' => 'room',
						'action' => url('api/calendar/room/create'),
						'id' => 'edit-meeting',
						'checkValid' => true,
						'rel' => 'notify',
						'done' => 'reload:'.url('calendar/room/{{resvId}}'),
						'children' => [
							'tbutton' => [
								'type' => 'button',
