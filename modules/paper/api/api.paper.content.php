...
class PaperContentApi extends Page {
	var $nodeId;
	var $apiClassName;
	var $apiMethod;
	var $modelClassName;
	...
	function __construct($nodeId = NULL, $apiMethod = NULL) {
		parent::__construct([
			'nodeInfo' => $nodeInfo = is_numeric($nodeId) ? \Paper\Model\PaperModel::get($nodeId, '{initTemplate: true}') : NULL,
