<?php
function view_ibuy_hatyaigogreen_toolbar($self,$title=NULL,$nav='default',$psn=NULL,$options='{}') {
	$defaults='{menu:""}';
	...
	*/
	...
	$self->theme->title=isset($title)?$title:'iBuy';
...
/*
	...
	*/
	$subnav=R::View('ibuy.'.$nav.'.nav',$psn,$options);
	if ($subnav) {
		$ret.='<nav class="nav -submodule -ibuy"><!-- nav of ibuy.'.$nav.'.nav -->';
		$ret.=$subnav;
		$ret.='</nav><!-- submodule -->';
	}
