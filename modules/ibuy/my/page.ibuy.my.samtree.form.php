...
function ibuy_my_samtree_form($self, $plantId = NULL) {
	...
	$ret = '<header class="header -box">'._HEADER_BACK.'<h3>พืซแซมยาง @'.$shopInfo->name.'</h3></header>';
	...
	$form->addField('tagname', array('type' => 'hidden', 'value' => 'GREEN,SAMTREE'));
