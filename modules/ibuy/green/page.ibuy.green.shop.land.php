...
function ibuy_green_shop_land($self, $shopInfo) {
	...
	foreach ($dbs->items as $rs) {
		...
		$headerNav->add('<a class="ag-action btn -link" href="'.url('ibuy/green/land/'.$rs->landid).'" data-webview="'.htmlspecialchars($rs->landname).'"><i class="icon -material">search</i></a>');
