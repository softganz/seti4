<?php
function view_ibuy_green_app_supplier_form_6($qtInfo) {
	$qtref=$qtInfo->qtref;
	...
	$form=new Form('data',url('ibuy/green/app/supplier/form/'.$qtref),'imed-poorman-form','imed-poorman-form');
	...
	*/
	...
	if ($isQtAdmin) {
		$form=new Form(NULL,url('ibuy/green/app/supplier/form/approve/'.$qtref),NULL,'sg-form imed-poorman-form-approve');
