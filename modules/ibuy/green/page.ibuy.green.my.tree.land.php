...
function ibuy_green_my_tree_land($self) {
	...
	foreach ($dbs->items as $rs) {
		$cardStr = '<a href="'.url('ibuy/green/my/tree/'.$rs->landid).'"><h3><i class="icon -material">nature_people</i><span>'.$rs->landName.'</span></h3>'
			. '<p>'.$rs->landDetail.'</p>'
			. '</a>';
