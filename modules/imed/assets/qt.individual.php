...
$qt['PSNL.RIGHT.SOCIALSECURITY.NO'] = [
...
$qt['DSBL.DEFECT.VISUAL'] = [
	'label'=>'ประเภทความพิการ',
	'type'=>'checkbox',
	'group'=>'defect',
	'option'=>'1:ทางการเห็น',
	'class'=>'-disabled-type',
	'done' => 'callback:reloadPage',
];
$qt['DSBL.DEFECT.HEARING'] = [
	'label'=>'ประเภทความพิการ',
	'type'=>'checkbox',
	'group'=>'defect',
...
$qt['โรคประจำตัว-ความดันโลหิตสูง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ความดันโลหิตสูง',
];
$qt['โรคประจำตัว-เบาหวาน'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:เบาหวาน',
];
$qt['โรคประจำตัว-ไขมันในเลือดสูง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ไขมันในเลือดสูง',
];
$qt['โรคประจำตัว-โรคหัวใจ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคหัวใจ',
];
$qt['โรคประจำตัว-โรคปอด'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคปอด/หอบหืด',
];
$qt['โรคประจำตัว-โรคถุงลมโป่งพอง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคถุงลมโป่งพอง',
];
$qt['โรคประจำตัว-ไตวาย'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ไตวาย',
];
$qt['โรคประจำตัว-มะเร็ง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:มะเร็ง',
];
$qt['โรคประจำตัว-ข้ออักเสบ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ข้ออักเสบ',
];
$qt['โรคประจำตัว-เก๊าท์'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ข้ออักเสบจากเก๊าท์/ข้อเสื่อม',
];
$qt['โรคประจำตัว-รูมาตอยด์'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ข้ออักเสบจากรูมาตอยด์',
];
$qt['โรคประจำตัว-โรคลมชัก'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคลมชัก',
];
$qt['โรคประจำตัว-โรคเส้นเลือดสมองตีบ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคเส้นเลือดสมองตีบ/อัมพฤกษ์/อัมพาต',
];
$qt['โรคประจำตัว-พาร์กินสัน'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:พาร์กินสัน/อาการสั่น',
];
$qt['โรคประจำตัว-อัลไซเมอร์'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:อัลไซเมอร์/สมองเสื่อม',
];
$qt['โรคประจำตัว-จิตเวช'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:มีอาการทางจิตเวช',
];
$qt['โรคประจำตัว-โรคอ้วน'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคอ้วน',
];
$qt['โรคประจำตัว-โรคสมองและหลอดเลือด'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
...
//ภาวะแทรกซ้อน
$qt['ภาวะแทรกซ้อน-แผลกดทับ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:แผลกดทับ',
];
$qt['ภาวะแทรกซ้อน-ข้อติดแข็ง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:ข้อติดแข็ง',
...
$qt['ภาวะแทรกซ้อน-กล้ามเนื้อเกร็งหรือกระตุก'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:กล้ามเนื้อเกร็งหรือกระตุก',
];
$qt['ภาวะแทรกซ้อน-อื่นๆ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:อื่นๆ',
];
$qt['ภาวะแทรกซ้อน-ระบุ'] = [
	'label'=>'',
	'type'=>'text',
	'group'=>'qt',
	'class'=>'w-5',
...
$qt['โรคประจำตัว-โรคทางระบบหัวใจและหลอดเลือด'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคทางระบบหัวใจและหลอดเลือด',
];
$qt['โรคประจำตัว-โรคทางระบบหลอดเลือดสมอง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคทางระบบหลอดเลือดสมอง',
];
$qt['โรคประจำตัว-โรคระบบกระดูกและข้อ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคระบบกระดูกและข้อ',
];
$qt['โรคประจำตัว-โรคระบบทางเดินอาหารและช่องท้อง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคระบบทางเดินอาหารและช่องท้อง',
];
$qt['โรคประจำตัว-โรคทางเดินปัสสาวะ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคทางเดินปัสสาวะ',
];
$qt['โรคประจำตัว-โรคทางตา'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคทางตา',
];
$qt['โรคประจำตัว-โรคออโตอิมมูน'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคออโตอิมมูน',
];
$qt['โรคประจำตัว-โรคระบบทางเดินหายใจ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคระบบทางเดินหายใจ',
];
$qt['โรคประจำตัว-โรคระบบต่อมไร้ท่อ'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'1:โรคระบบต่อมไร้ท่อ',
];
$qt['โรคประจำตัว-โรคทางระบบผิวหนัง'] = [
	'label'=>'',
	'type'=>'checkbox',
	'group'=>'qt',
...
$qt['HLTH.2.5.2.2'] = [
	...
	'class'=>'w-7',
	'pretext'=>'2.',
	'options' => ['placeholder' => 'รพ. 2',],
];
$qt['HLTH.2.5.2.3'] = [
	'label'=>'สถานที่รับการรกษา 3.',
	'type'=>'text',
	'group'=>'qt',
	'class'=>'w-7',
	'pretext'=>'3.',
	'options' => ['placeholder' => 'รพ. 3',],
];
$qt['HLTH.2.5.2.4'] = [
	'label'=>'สถานที่รับการรกษา 4.',
	'type'=>'text',
	'group'=>'qt',
	'class'=>'w-7',
	'pretext'=>'4.',
	'options' => ['placeholder' => 'รพ.สต.',],
];
$qt['HLTH.2.5.2.5'] = [
	'label'=>'สถานที่รับการรกษา 5.',
	'type'=>'text',
	'group'=>'qt',
	'class'=>'w-7',
	'pretext'=>'5.',
	'options' => ['placeholder' => 'อื่น ๆ ระบุ',],
];
...
$qt['HLTH.ความปลอดภัยของที่อยู่อาศัย'] = [
	'label'=>'ความปลอดภัยของที่อยู่อาศัย',
	'type'=>'radio',
	'group'=>'qt',
	'option'=>'1:ปลอดภัย, 2:ปลอดภัยปานกลาง, 3:ไม่ปลอดภัย',
];
$qt['HLTH.ความปลอดภัยของที่อยู่อาศัย.รายละเอียด'] = [
...
$qt['HLTH.ความมั่นคงของที่อยู่อาศัย'] = [
	'label'=>'ความมั่นคงของที่อยู่อาศัย',
	'type'=>'radio',
	'group'=>'qt',
	'option'=>'1:มั่นคงดี, 2:มั่นคงปานกลาง, 3:ไม่มั่นคง',
];
$qt['HLTH.ความมั่นคงของที่อยู่อาศัย.รายละเอียด'] = [
...
$qt['HLTH.สิ่งอำนวยความสะดวกให้สามารถดำรงชีวิตในบ้าน'] = [
...
$qt['HLTH.สิ่งอำนวยความสะดวกให้สามารถดำรงชีวิตในบ้าน.รายละเอียด'] = [
...
$qt['HLTH.การรับบริการด้านสุขภาพ'] = [
...
$qt['DSBL.SHOULDHELP.การฝึกทักษะเพื่อการดำรงชีวิตตามความต้องการ'] = [
	'label'=>'การฝึกทักษะเพื่อการดำรงชีวิตตามความต้องการ',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'การฝึกทักษะเพื่อการดำรงชีวิตตามความต้องการ',
];
$qt['DSBL.SHOULDHELP.ส่งต่อคนพิการเข้ารับการตรวจร่างกายหรือฟื้นฟูจากแพทย์เฉพาะทาง'] = [
...
$qt['DSBL.SHOULDHELP.อื่นๆ'] = [
	'label'=>'อื่นๆ.ระบุ',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'อื่น ๆ',
];
$qt['DSBL.SHOULDHELP.อื่นๆ.ระบุ'] = [
	'label'=>'อื่นๆ.ระบุ',
	'type'=>'textarea',
	'group'=>'qt',
	'class'=>'w-9',
...
$qt['DSBL.HELPER.QUALITY.TRAINING.BY'] = [
...
$qt['OTHR.SERVICE.NEEDEQUITY.IDENTIFY'] = [
	'label'=>'ต้องการดำเนินการให้ได้รับความเป็นธรรมเพื่อได้สิทธิ์นั้นๆ',
	'type'=>'text',
	'group'=>'qt',
	'class'=>'w-3',
...
$qt['OTHR.SERVICE.MONEY.FREQUENTLY'] = [
	'label'=>'ได้รับเบี้ยความพิการหรือบี้ยยังชีพผู้สูงอายุ-โดย',
	'type'=>'radio',
	'group'=>'qt',
	'pretext'=>'ได้รับอย่างไร',
...
$qt['OTHR.SERVICE.PROBLEM'] = [
	'label'=>'ปัญหาในด้านบริการ/สวัสดิการ',
	'type'=>'textarea',
	'class'=>'w-10',
	'group'=>'qt',
];
$qt['OTHR.SERVICE.WANT'] = [
...
$qt['OTHR.WELFARECOMMUNITY.PROBLEM'] = [
...
$qt['DSBL.SEE.ไม่มีรูหูทั้งสองข้าง'] = [
	'label'=>'ไม่มีรูหูทั้งสองข้าง',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'2.1:ไม่มีรูหูทั้งสองข้าง',
];
$qt['DSBL.SEE.หูหนวกสองข้าง'] = [
	'label'=>'หูหนวกสองข้าง',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'2.2:หูหนวกสองข้าง',
];
$qt['DSBL.SEE.หูตึงสองข้าง'] = [
	'label'=>'สายตาเลือนรางสองข้าง',
	'type'=>'checkbox',
	'group'=>'qt',
...
$qt['DSBL.SEE.มีข้อยึดติด'] = [
	'label'=>'มีข้อยึดติด',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'3.18:มีข้อยึดติด',
];
$qt['DSBL.SEE.แขนขาดข้างขวา'] = [
	'label'=>'แขนขาดข้างขวา',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'3.19:แขนขาดข้างขวา',
];
$qt['DSBL.SEE.แขนขาดข้างซ้าย'] = [
	'label'=>'แขนขาดข้างซ้าย',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'3.20:แขนขาดข้างซ้าย',
];
$qt['DSBL.SEE.ขาขาดข้างขวา'] = [
	'label'=>'ขาขาดข้างขวา',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'3.21:ขาขาดข้างขวา',
];
$qt['DSBL.SEE.ขาขาดข้างซ้าย'] = [
	'label'=>'ขาขาดข้างซ้าย',
	'type'=>'checkbox',
	'group'=>'qt',
...
$qt['DSBL.SEE.หลงผิดหวาดระแวง'] = [
	'label'=>'หลงผิดหวาดระแวง',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'4.3:หลงผิดหวาดระแวง',
];
$qt['DSBL.SEE.พูดคนเดียว'] = [
	'label'=>'พูดคนเดียว',
	'type'=>'checkbox',
	'group'=>'qt',
...
$qt['DSBL.SEE.ด้านการอ่าน'] = [
	'label'=>'ด้านการอ่าน',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'6.1:ด้านการอ่าน',
];
$qt['DSBL.SEE.ด้านการเขียน'] = [
	'label'=>'ด้านการเขียน',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'6.2:ด้านการเขียน',
];
$qt['DSBL.SEE.ด้านการคำนวณ'] = [
	'label'=>'ด้านการคำนวณ',
	'type'=>'checkbox',
	'group'=>'qt',
	'option'=>'6.3:ด้านการคำนวณ',
];
$qt['DSBL.SEE.ด้านการเรียนรู้'] = [
