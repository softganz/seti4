...
function imed_poorman($self, $psnid = NULL) {
	...
	$mainUi->add('<a class="sg-action" href="'.url('imed/app/poorman/report/area').'" data-webview="จำแนกตามพื้นที่"><i class="icon -material">show_chart</i><span>พื้นที่</span></a>');
	$mainUi->add('<a class="sg-action" href="'.url('imed/app/poorman/report/type').'" data-webview="ประเภทความยากลำบาก"><i class="icon -material">show_chart</i><span>ประเภท</span></a>');
